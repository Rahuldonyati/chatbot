...
export function AppSidebar() {
  return (
    <Card className="flex flex-col h-screen w-14 pt-4 bg-primary text-white dark:bg-purple-dark border-4 border-purplelight rounded-l-none rounded-r-3xl  z-40">      {/* Logo at the top */}
